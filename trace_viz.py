...
def tplot(x):
    ...
    fig.add_trace(go.Scatter(x=x1, y=x[:,0],name='E component'),row=1,col=1)
    fig.add_trace(go.Scatter(x=x1, y=x[:,1],name='N component'),row=2,col=1)
    fig.add_trace(go.Scatter(x=x1, y=x[:,2],name='Z component'),row=3,col=1)
...
def fplot(fr):
    ...
    fig1.add_trace(go.Scatter(x=m, y=fr[:,0],name='E component'),row=1,col=1)
    fig1.add_trace(go.Scatter(x=m, y=fr[:,1],name='N component'),row=2,col=1)
    fig1.add_trace(go.Scatter(x=m, y=fr[:,2],name='Z component'),row=3,col=1)
